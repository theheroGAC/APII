...
CHINESE_S["MENU_PSVITA_INSTALL_SD2VITA_DESC"] =					"安装 SD2VITA 插件 (StorageMgr,由 CelesteBlue 开发)"
CHINESE_S["MENU_PSVITA_CONFIG_SD2VITA_DESC"] =						"配置 SD2VITA 插件 (StorageMgr,由 CelesteBlue 开发)"
...
CHINESE_S["CUSTOMBOOTSPLASH_MESSAGE"] =				"请记住启用 Custom Boot Splash 插件"
...
--Boot_config.txt
CHINESE_S["MENU_EXTRAS_CUSTOMBOOTSPLASH_DESC"] =			"此插件将在 PS Vita/PSTV 启动时显示自定义启动画面. 需要 ENSO."
