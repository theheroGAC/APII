...
JAPANESE["MENU_EXTRAS_TRANSLATE"] =			"Autopluginを翻訳"
JAPANESE["TRANSLATE_ENGLISH_TITLE"] =		"英語: "
JAPANESE["TRANSLATE_CURRENT_TITLE"] =		"現在の翻訳: "
JAPANESE["TRANSLATE_YOUR_TITLE"] =		"修正後の翻訳: "
JAPANESE["MENU_EXTRAS_TRANSLATE_DESC"] =		"使用中の言語に翻訳する事で、Autopluginを改善出来ます"
...
--Desc Options PSVITA
JAPANESE["MENU_PSVITA_INSTALL_PLUGINS_DESC"] =		"SCENE-PSVITA製の最も有用なプラグインを導入する"
JAPANESE["MENU_PSVITA_UNINSTALL_PLUGINS_DESC"] =		"プラグインを簡単に削除する"
JAPANESE["MENU_PSVITA_INSTALL_SD2VITA_DESC"] =		"SD2VITAプラグインの導入 (CelesteBlue氏作StorageMgr)"
JAPANESE["MENU_PSVITA_CONFIG_SD2VITA_DESC"] =		"SD2VITAプラグインの設定 (CelesteBlue氏作StorageMgr)"
JAPANESE["MENU_PSVITA_CHECK_ONLINE_PLUGINS_DESC"] =		"新しく更新されたプラグインの有無を確認します"
JAPANESE["MENU_PSVITA_TITLE"] =			"PS Vitaのプラグイン"
JAPANESE["MENU_PSVITA_INSTALL_SD2VITA"] =		"SD2VITAプラグインの導入"
JAPANESE["MENU_PSVITA_CONFIGURE_SD2VITA"] =		"SD2VITAプラグインの設定"
JAPANESE["MENU_PSVITA_INSTALL_PLUGINS"] =		"プラグインの導入"
JAPANESE["MENU_PSVITA_UNINSTALL_PLUGINS"] =		"プラグインの削除"
JAPANESE["MENU_PSVITA_CHECK_ONLINE_PLUGINS"] =		"プラグインの更新の確認"
JAPANESE["MENU_PSP_TITLE"] =			"PSP (Adrenaline) のプラグイン"
JAPANESE["MENU_PSP_INSTALL_NPDRMFREE"] =		"qwikrazor87氏作npdrm freeプラグインの導入"
JAPANESE["MENU_PSP_INSTALL_REMASTERED_CTRLS"] =	"TheOfficialFloW氏作RemasteredControlsプラグインの導入"
JAPANESE["MENU_PSP_INSTALL_PLUGINS"] =		"AdrenalineのPSPプラグイン"
JAPANESE["MENU_EXTRAS_CONVERT_BOOTSPLASH"] =		"Custom Boot Splashの設定"
JAPANESE["MENU_EXTRAS_CUSTOM_WARNING"] =		"Custom Warning Messageの設定"
...
JAPANESE["MENU_EXTRAS_CUSTOM_PKG_CONFIG_DESC"] =		"PKGJの config.txt でのオプションのカスタマイズを許可します"
...
--install plugins
JAPANESE["LIST_PLUGINS"] =		"導入可能なプラグイン一覧: "
JAPANESE["MARK_PLUGINS"] =			"プラグインの選択 / 選択解除"
JAPANESE["INSTALLP_CONFIRM"] =			"プラグインの導入"
JAPANESE["INSTALLP_ALL"] =			"全てのプラグインの導入"
JAPANESE["CLEAN_PLUGINS"] =			"選択したプラグインの選択解除"
JAPANESE["LR_SWAP"] =			"ux0:/ ur0:/ の切り替え"
JAPANESE["PLUGINS_CUSTOM_PATH"] =		"任意の場所に導入"
...
--config pkgj
JAPANESE["MENU_EXTRAS_PKGJ_TITLE"] =			"PKGJコンフィグの設定"
...
JAPANESE["MENU_PSP_NPDRMFREE_DESC"] =			"npdrm freeは正式な .rif ライセンスや act.dat を必要とせずに、公式のPS1 / PSPコンテンツを実行する為のPSP / ePSPプラグイン"

--customWarning
JAPANESE["CUSTOMWARNING_MESSAGE"] =		"Custom Warningプラグインを有効にする事を忘れないで下さい"

--customsplash
JAPANESE["CUSTOMBOOTSPLASH_TITLE"] =		"Custom Boot Splash"
JAPANESE["CUSTOMBOOTSPLASH_CONVERT"] =		"画像の変換"
JAPANESE["CUSTOMBOOTSPLASH_IMPORT"] =		"ギャラリーから画像をインポートする ( .png 限定)"
JAPANESE["CUSTOMBOOTSPLASH_MESSAGE"] =		"Custom Boot Splashプラグインを有効にする事を忘れないで下さい"
...
JAPANESE["MENU_PSP_PSPCTRLS_DESC"] =			"Adrenaline上のPSPゲームでPS Vitaのデュアルアナログスティックで操作可能にする"
...
JAPANESE["MENU_PSP_PLUGINS_DESC"] =			"AdrenalineのPSPプラグインを導入"
...
--Boot_config.txt
JAPANESE["MENU_EXTRAS_CUSTOMBOOTSPLASH_DESC"] =	"このプラグインは、起動時にPS Vita / PS TVにBoot Splashを表示させる事が出来ます (Ensoが必要)"
...
JAPANESE["MENU_EXTRAS_CUSTOMWARNING_DESC"] =	"Ensoで起動する時に公式警告メッセージの代わりにカスタムメッセージを設定出来ます"
