...
ITALIAN["UPDATER_DOWNLOADING"] =               			"Scaricamento dell Aggiornamento in corso..."
...
ITALIAN["UPDATER_ERROR"] =               				"Errore di AUTOAGGIORNAMENTO!!!"
...
--StorageMgr
ITALIAN["INSTALLP_DESC_SD2VITA"] =					"Installa Plugin per SD2VITA"
...
ITALIAN["INSTALLP_DESC_PSVSHELL"] =						"Un altro plugin per overcloccare la PSVITA"
...
ITALIAN["INSTALLP_DESC_MONAURAL"] =						"Audio mono e bilanciamento dei canali per Playstation Vita (richiede vpk dell'applicazione)."
...
ITALIAN["INSTALLP_DESC_NOSHAREDFB"] =				"Consente di aggirare i problemi di framebuffer condivisi dopo il ciclo di sospensione/ripresa per le applicazioni homebrew eseguite in modalità di sistema  e utilizza l implementazione standard di framebuffer."

--ALL
ITALIAN["INSTALLP_DESC_VSHMENU"] =						"Un plugin con VSH menu per i giochi PSVITA e gli homebrew"
...
ITALIAN["INSTALLP_DESC_REMAPSV"] =						"remaPSV è un plugin di rimappatura che ti consente di rimappare ogni singolo pulsante della PSVita e di mappare le zone touch e reartouch come pulsanti extra."
...
ITALIAN["INSTALLP_DESC_MODALVOL"] =				    	"Questo pacchetto comprende applicazioni per controllare il volume audio del sistema su PSvita in tempo reale senza chiudere i giochi"
